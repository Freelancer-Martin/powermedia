...
<html>
    ...
    <div class="album text-muted">
      <div class="container">
        <div class="row">
        <div style="padding-left: 10%;" class="col-lg-10">
          <div class="card">
						<a id="preview" href="select-vix-theme-chart-layout.php" >
							<img src="img/PowerPlant 2.jpg">
						</a>
            <h1 style="padding-left: 5%;font-size: 20px;" class="card-text">Greenhouse gas Emicions</h1>
          </div>
          <div class="card">
						<a id="preview" href="select-vix-theme-chart-layout.php" >
							<img src="img/house.jpg">
						</a>
            <h1 style="padding-left: 5%;font-size: 20px;" class="card-text">House Things</h1>
          </div>
          <div class="card">
						<a id="preview" href="select-vix-theme-chart-layout.php" >
							<img src="img/Light Bulb.jpg">
						</a>
            <h1 style="padding-left: 5%;font-size: 20px;" class="card-text">Energy Consumptions</h1>
          </div>

          <div class="card">
						<a id="preview" href="select-vix-theme-chart-layout.php" >
							<img src="img/Garbage truck.jpg">
						</a>
            <h1 style="padding-left: 5%;font-size: 20px;" class="card-text">Garbage Truck</h1>
          </div>
          <div class="card">
						<a id="preview" href="select-vix-theme-chart-layout.php" >
							<img src="img/landfill1.jpg">
						</a>
            <h1 style="padding-left: 5%;font-size: 20px;" class="card-text">Landfill Rate Of Waste</h1>
          </div>

          <div class="card">
						<a id="preview" href="select-vix-theme-chart-layout.php" target="_blank">
							<img src="img/bins.jpg">
						</a>
            <h1 style="padding-left: 5%;font-size: 20px;" class="card-text">Main GDP</h1>
          </div>

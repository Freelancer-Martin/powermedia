...
<html>
    ...
    <div class="album text-muted">
      <div class="container">
        <div class="row">
        <div style="padding-left: 23%;" class="col-lg-10">
          <div class="viz-card">
						<a id="preview" href="layout-column-chart.php" >
							<img src="img/powermedia_icons_column.jpg">
						</a>
            <h1 style="padding-left: 5%;font-size: 20px;" class="card-text">Columns Charts</h1>
          </div>
          <div class="viz-card">
						<a id="preview" href="layout-area-chart.php" >
							<img src="img/powermedia_icons_spiline.jpg">
						</a>
            <h1 style="padding-left: 5%;font-size: 20px;" class="card-text">Spiline Area Chart</h1>
          </div>
          <div class="viz-card">
						<a id="preview" href="layout-range-columns-charts.php" >
							<img src="img/powermedia_icons_range.jpg">
						</a>
            <h1 style="padding-left: 5%;font-size: 20px;" class="card-text">Range Columns Chart</h1>
          </div>

          <div class="viz-card">
						<a id="preview" href="bubble-chart-layout.php" >
							<img src="img/powermedia_icons_bubble.jpg">
						</a>
            <h1 style="padding-left: 5%;font-size: 20px;" class="card-text">Buuble Chart</h1>
          </div>
